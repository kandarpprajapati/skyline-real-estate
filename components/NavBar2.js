        ...
        <div className="mx-auto px-4 sm:px-6">
          ...
          */}
                ...
                <div
                  ...
                  className={
                    flyer
                      ? " opacity-100 translate-y-0 transition ease-out duration-200 absolute -ml-4 mt-3 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2"
                      : " opacity-0 translate-y-1 absolute -ml-4 mt-3 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2"
                  }
                >
