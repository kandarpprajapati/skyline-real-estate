    ...
    <>
      ...
      <div className="flex flex-col md:flex-row mx-auto w-full items-center justify-between">
        <div className="w-1/3 p-6 mx-auto">
          <img src={property.images} alt="Property Image" className="w-full" />
        </div>
        <div className="md:w-2/4 p-6">
          ...
          <div className="flex mb-4">
            ...
            <p className="text-lg">
              Location: {property.building_no} {property.address}
            </p>
          </div>
          <div className="flex mb-4">
            <svg
          ...
          <div className="flex mb-4">
            ...
            <p className="text-lg">Halls: {property.halls}</p>
          </div>
          <div className="flex mb-4">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <p className="text-lg">Kitchen: {property.kitchen}</p>
          </div>
          <div className="flex mb-4">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <p className="text-lg">{property.other_facilities}</p>
          </div>
          <div className="flex mb-4">
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="w-full md:w-1/3 p-6 ml-32">
        ...
        <div className="flex items-center mb-4">
          ...
          <p className="text-lg">Owner Name: John Doe</p>
        </div>
        <div className="flex items-center mb-4">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <p className="text-lg">Contact Number: 123-456-7890</p>
        </div>
        <div className="flex items-center mb-4">
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="flex items-center mb-4">
          ...
          <p className="text-lg">Address: 123 Main St, City</p>
        </div>
      </div>
    </>
  );
